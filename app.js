        ...
        function gukeiCheck(lastX, lastY, removedStonesCnt) {
            ...
            function isSakare(color, x, y) {
                ...
                if (board[y][x - 1] === ememyColor
                    ...
                    // ?の位置に相手の石が無いこと
                    if (board[y - 1][x] !== ememyColor && board[y][x + 1] !== ememyColor && board[y + 2][x] !== ememyColor) {
                        console.log("2-1");
                        return true;
                    }
                }
                ...
                if (board[y - 1][x - 1] === ememyColor && board[y - 1][x] === color
                    ...
                    // ?の位置に相手の石が無いこと
                    if (board[y - 2][x] !== ememyColor && board[y][x - 1] !== ememyColor && board[y + 1][x] !== ememyColor) {
                        console.log("2-2");
                        return true;
                    }
                }
                ...
                if (board[y - 1][x] === ememyColor
                                                    ...
                                                    && board[y + 1][x + 1] === ememyColor) {
                    // ?の位置に相手の石が無いこと
                    if (board[y - 1][x + 1] !== ememyColor && board[y][x + 2] !== ememyColor && board[y + 1][x] !== ememyColor) {
                        console.log("4-1");
                        return true;
                    }
                }
